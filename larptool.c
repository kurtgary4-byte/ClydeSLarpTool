       ...
       if(YandN == 'y' || YandN == 'Y'){
          ...
          printf("\033[0;32mAttacking...\n\033[0m");
           ...
           printf("\033[0;32mPassword cracked, trying new password...\n\033[0m");
              ...
              printf("\033[0;32mreading the files...\n\033[0m");
              usleep(500000);
              printf("\033[0;33mUploading files to the dark web./n/033[0m");
    usleep(500000);
printf("\033[0;33mUploading files to the dark web../n/033[0m");
    usleep(500000);
printf("\033[0;33mUploading files to the dark web.../n/033[0m");
    usleep(2500);
printf("\033[0;33mUpload succsefull,/n/033[0m");
usleep(2500);
printf("\033[0;33mGetting passwords./n/033[0m");
usleep(500000);
printf("\033[0;33mGetting passwords../n/033[0m");
usleep(500000);
printf("Getting passwords...");
usleep(2500);
       }else{
